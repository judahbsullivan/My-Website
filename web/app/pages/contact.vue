      ...
      <div class=" px-4 sm:px-6">
        <div ref="headerRef" class="mb-16 sm:mb-20 opacity-0">
          <div ref="titleWrapperRef" class="overflow-hidden">
            <UiTitle ref="titleRef" as="h1" size="5xl" weight="bold" align="left" class="mb-6 opacity-0">
              Get in Touch
            </UiTitle>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div ref="formRef"
            ...
            <div ref="formTitleWrapperRef" class="overflow-hidden mb-8">
              <UiTitle ref="formTitleRef" as="h2" size="md" weight="semibold" class="opacity-0">
                Send a Message
              </UiTitle>
            </div>
          ...
          <div class="space-y-6">
            <div ref="contactInfoRef"
              ...
              <div ref="contactInfoTitleWrapperRef" class="overflow-hidden mb-6">
                <UiTitle ref="contactInfoTitleRef" as="h3" size="md" weight="semibold" class="opacity-0">
                  Contact Information
                </UiTitle>
              </div>
            ...
            <div ref="faqRef"
              ...
              <div ref="faqTitleWrapperRef" class="overflow-hidden mb-6">
                <UiTitle ref="faqTitleRef" as="h3" size="md" weight="semibold" class="opacity-0">
                  Quick Questions?
                </UiTitle>
              </div>
              <div class="space-y-5">
